...
import os
# clean up
#if os.path.exists("Prepare_data/training_iris.data"):
#    os.remove("Prepare_data/training_iris.data")
...
training_file = open("Prepare_data/training_iris.data", "w+")
test_file = open("Prepare_data/test_iris.data", "w+")
